...
function goHome() {
    $("html, body").animate({scrollTop: $('#app-body').offset().top}, 100);
};

function goPackages() {
    $("html, body").animate({scrollTop: $('#packages').offset().top}, 100);
};

function goServices() {
    $("html, body").animate({scrollTop: $('#servicesList').offset().top}, 100);
};

function goCleints() {
    $("html, body").animate({scrollTop: $('#clients').offset().top}, 100);
};
